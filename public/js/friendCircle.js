export class FriendCircle {
    ...
    createContainers() {
        ...
        this.root.append(this.randomArticleContainer, this.container, this.loadMoreBtn, this.statsContainer);
    }
    ...
    displayArticles() {
        const articles = this.allArticles.slice(this.start, this.start + this.config.page_turning_number);

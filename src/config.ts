...
export const siteConfig: SiteConfig = {
	title: "ZSXの小站",
	subtitle: "我的博客，在这里记录我的资源分享、踩坑教程和生活日常。",
	siteURL: "https://blog.zsx915.top/", // 请替换为你的站点URL，以斜杠结尾
...
export const profileConfig: ProfileConfig = {
	avatar:
		"https://img-zsx.oss-cn-shanghai.aliyuncs.com/cb04a9a64f09bd4ba85d9908439653ed.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "钟神秀",
	bio: "造化钟神秀，阴阳割昏晓。",
	typewriter: {
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/396923563",
		},
		// {
		// 	name: "Gitee",
		// 	icon: "mdi:git",
		...
		},
		{
			name: "QQ",
			icon: "fa6-brands:qq",
			url: "https://qm.qq.com/q/QKiovnkOkO",
		},
		{
			name: "RSS",
			icon: "mdi:rss",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://github.com/mcyzsx", // 关于链接
	},
};
